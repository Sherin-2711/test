...
const HospitalFinder = () => {
  ...
  // Initialize map and get user location immediately
  useEffect(() => {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          (position) => {
            ...
            updateUserLocation(position, mapInstance);
          },
          (err) => {
            setError("Error getting location: " + err.message);
            mapInstance.setView([51.505, -0.09], 13); // Default view if geolocation fails
          },
          {
